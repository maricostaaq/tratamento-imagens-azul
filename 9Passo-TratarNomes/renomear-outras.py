...
def renomear_questoes_simples():
    pasta = "61-90" # ATUALIZAR com o nome da pasta das questões que você vai arrumar 
    ...
    for i in range(59, 88+1):    # atualize seu for com o número da primeira imagem "parte_AlgumaCoisa.png" até o número da última imagem "parte_AlgumaCoisa.png" mais 1 da pasta
        antigo = f"parte_{i:03d}.png"
        #novo = f"questao-{i-6}-espanhol.png"  # faça uma conta: se a primeira pagina for 
        #novo = f"questao-{i-1}-inglês.png"
